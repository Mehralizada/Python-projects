...
api_key = "8e5cc919254595d7a0091435df0e5022"
iconUrl = "https://openweathermap.org/img/wn/{}@2x.png"

def getWeather(city):
    params = {"q":city,"appid":api_key,"lang":"az"}
...
app.title("Hava proqnozu")

cityEntry = Entry(app,justify="center")
cityEntry.pack(fill=BOTH,ipady=10,padx=18,pady=5)
cityEntry.focus()

searchButton = Button(app,text="Axtarış",font=("Arial",15),command=main)
